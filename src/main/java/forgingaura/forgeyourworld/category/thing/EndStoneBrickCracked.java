...
public class EndStoneBrickCracked extends Block{
    ...
    public EndStoneBrickCracked() {
        super(Material.ROCK);
        setUnlocalizedName(MainHandler.FYWBlocks.ENDSTONEBRICKCRACKED.getRegistryName());
        setRegistryName(MainHandler.FYWBlocks.ENDSTONEBRICKCRACKED.getRegistryName());
        setHardness(3.0F);
